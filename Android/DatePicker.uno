...
{
	extern(!Android) class MyDatePickerView
	{
		[UXConstructor]
		public MyDatePickerView([UXParameter("Host")]MyDatePicker host) { }
	}

	extern(Android) class MyDatePickerView : LeafView, IMyDatePickerView
	{
		MyDatePicker _host;

		[UXConstructor]
		public MyDatePickerView([UXParameter("Host")]MyDatePicker host) : base(Create())
		{
			_host = host;
